...
public class LinkedListStack<T> implements StackIF<T>{
  ...
  public int size() {
    ...
    Node<T> current = top; 
    /*
    top을 직접 사용하지 않고, current를 사용해 순회 (top을 직접 사용하면 week1.stack 파괴, java.lang.NullPointerException: Cannot read field "link" because "this.top" is null)
